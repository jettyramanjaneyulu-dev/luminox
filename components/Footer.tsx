...
// ── Reusable Contact block (used in both desktop + mobile) ──
  ...
  return (
    <div>
      ...
      <a
        ...
        style={{ ...contactLinkStyle, marginBottom: "10px" }}
      >
        <PinIcon />
        <span>
          LUMINOX DERMA CLINIC,
          <br />
          #444, Floor 3, Vishnu lekha plaza,
          <br />
          Kesav Nagar, Srinagar Colony, Banjara Hills,
          <br />
        ...
        <ul style={{ listStyle: "none", padding: "0 0 16px 0", margin: 0 }}>
          {links.map((l) => (
            <li key={l.label} style={{ marginBottom: "12px" }}>
              <Link
                href={l.href}
                style={{ color: "#5C3A14", textDecoration: "none", fontSize: "13.5px", cursor: "pointer" }}
              >
                {l.label}
              </Link>
            </li>
  ...
  return (
    <footer style={{ position: "relative", background: "#DFAA5E" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "100px 24px 40px" }}>
        ...
        <div className="footer-desktop">
          <div
            style={{
              display: "grid",
              gridTemplateColumns: "2fr 1.2fr 1.2fr 1.8fr",
              gap: "40px",
              marginBottom: "56px",
            }}
          >
            {/* LOGO */}
            <div>
              <Image src="/header/Luminox.png" alt="Luminox" width={160} height={60} />
              <p style={{ marginTop: "14px", fontStyle: "italic", fontFamily: "Georgia, serif", color: "#3B1F0A", fontSize: "17px", letterSpacing: "0.03em" }}>
                Radiance Perfected
              </p>
            ...
            {/* TREATMENTS */}
            <div>
              <h4 style={{ color: "#3B1F0A", fontWeight: "800", fontSize: "11px", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: "18px" }}>
                Treatments
              </h4>
        ...
        <div className="footer-mobile" style={{ marginBottom: "40px" }}>
          ...
          <div style={{ marginBottom: "24px", paddingBottom: "24px", borderBottom: "1px solid rgba(59,31,10,0.15)" }}>
            ...
            <p style={{ marginTop: "12px", fontStyle: "italic", fontFamily: "Georgia, serif", color: "#3B1F0A", fontSize: "16px" }}>
              Radiance Perfected
            </p>
      ...
      <style>{`
        ...
        .social-icon:hover {
          background: rgba(59,31,10,0.28) !important;
