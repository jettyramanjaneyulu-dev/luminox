...
export default function Appointment() {
  ...
  return (
    <>
      {/* Inline style for parallax background */}
      <style>{`
        .parallax-section {
      ...
      <section className="parallax-section relative min-h-screen flex items-center justify-center py-20 px-6 overflow-hidden">

        {/* Dark overlay */}
        <div className="absolute inset-0 bg-[#292E4B]/60 z-0" />
